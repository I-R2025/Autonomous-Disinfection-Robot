  ...
  public:
    ...
    void setParams(URGConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("topic"==(*_i)->name){topic = boost::any_cast<std::string>(val);}
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.topic = "";
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.topic = "scan";
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(URGConfig::AbstractParamDescriptionConstPtr(new URGConfig::ParamDescription<std::string>("topic", "str", 0, "Output laserscan topic for the laserscan.", "", &URGConfig::topic)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(URGConfig::AbstractParamDescriptionConstPtr(new URGConfig::ParamDescription<std::string>("topic", "str", 0, "Output laserscan topic for the laserscan.", "", &URGConfig::topic)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
